...
: ${AMENT_CURRENT_PREFIX:="/home/user/nanosaur/install/nanosaur_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nanosaur_gazebo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nanosaur_gazebo/environment/path.sh"
