...
: ${AMENT_CURRENT_PREFIX:="/home/user/nanosaur/install/nanosaur"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nanosaur/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nanosaur/environment/path.sh"
