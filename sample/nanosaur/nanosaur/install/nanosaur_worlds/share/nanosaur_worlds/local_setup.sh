...
: ${AMENT_CURRENT_PREFIX:="/home/user/nanosaur/install/nanosaur_worlds"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nanosaur_worlds/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nanosaur_worlds/environment/path.sh"
