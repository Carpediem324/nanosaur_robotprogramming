#Before code is for the contest of robot tracing
#so I know the map shape and make hard coding about tuning and motor control
#But this code is for simulator
#It is generally work on GAZEBO simulator
